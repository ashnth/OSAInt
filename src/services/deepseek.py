...
def generate_prompt_advice(graph, hibp_results, sherlock_results, holehe_results):
    prompt = (
        ...
        "2. **For each exposed account, email, or username:**\n"
        ...
        "   - Use clear section headings (e.g., 'Email: john@example.com') for each account/email/username.\n"
        ...
        "- For each piece of advice, use numbered lists for steps and bold important actions.\n"
        ...
        "- Separate sections for each account/email/username as needed.\n"
        "- If there are both reactive and proactive steps, clearly label them as such.\n"
